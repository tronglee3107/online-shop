...
function Login() {
    ...
    const submitHandler = async (event) => {
        try {
            ...
            const {data} = await axios.post(`/api/user/${state}`, state === 'login' ? {email, password} : {name, email, password});
            if (data.success) {
                ...
                {state === "register" ? (
                    <p>
                        ...
                        <span
                            ...
                            className="primary cursor-pointer text-primary">
                            Click here
                        </span>
                    </p>
                ) : (
                    <p>
                        ...
                        <span
                            ...
                            className="text-primary cursor-pointer text-primary">
                            Click here
                        </span>
                    </p>
                )}
