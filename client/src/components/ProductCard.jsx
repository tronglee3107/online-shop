...
export const ProductCard = ({product}) => {
    const {currency, addToCart, updateCartQuantity, removeFromCart, navigate, cartItems} = useAppContext();
    ...
    return product && (
        <div onClick={() => {
            ...
            className="border border-gray-500/20 rounded-md md:px-4 px-3 py-2 bg-white min-w-56 max-w-56 w-full mt-10">
